...
Memory::Memory() noexcept
{
    ...
    SDL_SetRelativeMouseMode = sdl2.GetProcAddress<decltype(SDL_SetRelativeMouseMode)>("SDL_SetRelativeMouseMode");
    SDL_SetWindowGrab = sdl2.GetProcAddress<decltype(SDL_SetWindowGrab)>("SDL_SetWindowGrab");
    SDL_WarpMouseInWindow = sdl2.GetProcAddress<decltype(SDL_WarpMouseInWindow)>("SDL_WarpMouseInWindow");
}
